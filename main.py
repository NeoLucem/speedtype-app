...
class TypeSpeedGUI:
    ...
    def __init__(self):
        ...
        self.sample_label = tk.Label(self.frame, text=random.choice(self.text), font=("Helvetica", 24))
        self.sample_label.grid(row=0, columnspan=2, padx=5, pady=5)
        ...
        self.speed_label.grid(row=2, columnspan=2, padx=5, pady=5)
    ...
    def time_thread(self):
        while self.running:
            ...
            wpm = wps * 60
            self.speed_label.config(text=f"Speed: \n{cps:.2f} Character per seconds\n{cpm:.2f} Character per minutes\n {wpm: .2f} Words per minutes")
